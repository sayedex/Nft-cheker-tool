...
<div className="pt-2 pb-1 bg-white bg-opacity-[75%] border-b dark:border-secondary-dark transform backdrop-blur-md text-white dark:text-white z-50 sticky top-[0px] w-full h-[95px] px-6 md:px-10 flex items-center justify-between" id={style.mainheader} >
...
{/* account info part */}
<div id={style.Account_info} className="z-1 md:flex-0 hidden">
...
{active==false?(<button onClick={()=>Connectwithweb3()} className='text-black font-bold py-2 px-4 rounded-full'>Connect
</button>):active && <div id={style.toggle} className="flex items-center gap-x-2 sm:gap-x-5">
{/* logo */}
...
{ show_mobile_manu ==true?
  <div id={style.mobile_manu} className="md:hidden">
