...
const Newlist = createSlice({
    ...
    reducers: {
        ...
        Search(state,action){
            const Search_sort =  state.AllListed.filter((Cel:NFT)=>{
      ...
      const Sort = state.AllListed.sort((a:NFT,b:NFT)=>{
     ...
     case filterItem.HighToLow:
        const Sort_Low = state.AllListed.sort((a:NFT,b:NFT)=>{
      ...
      case filterItem.TokenID:
        const Sort_tokenid = state.AllListed.sort((a:NFT,b:NFT)=>{
